  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-950 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="absolute bottom-0 -left-16 w-72 h-72 bg-red-900/30 rounded-full blur-2xl" />
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-5xl font-black text-white leading-tight mb-6">
            ...
            memory is
            <br />
            <span className="text-red-500">one tap away.</span>
          </h2>
          <p className="text-gray-400 text-base leading-relaxed max-w-sm">
            Create your account and instantly unlock concerts, sports matches, theatre shows, and more — across 150+ cities.
          </p>
        </div>
        ...
        <div className="relative z-10 flex flex-col gap-3">
          {[
            ...
            <p key={perk} className="text-sm text-gray-400 font-medium">
              {perk}
            </p>
          ))}
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white relative overflow-y-auto">
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-red-50 rounded-full blur-3xl opacity-60 -z-0" />
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              {form.password.length > 0 && (
                <div className="mt-1">
                  ...
                  <p className={`text-xs font-semibold ${
                    ...
                    pwdStrength === 3 ? "text-yellow-500" : "text-emerald-500"
                  }`}>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className={`w-full px-4 py-3.5 pr-12 rounded-xl border bg-gray-50 text-gray-900 text-sm placeholder-gray-400 outline-none focus:bg-white focus:ring-4 transition-all duration-200 ${
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              ...
              <span className="text-red-500 font-semibold cursor-pointer hover:underline">Terms of Service</span>{" "}
              and{" "}
              <span className="text-red-500 font-semibold cursor-pointer hover:underline">Privacy Policy</span>.
            </p>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-red-600 text-white font-black text-sm py-4 rounded-xl hover:bg-red-700 active:scale-[0.98] transition-all duration-200 shadow-lg shadow-red-200 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
